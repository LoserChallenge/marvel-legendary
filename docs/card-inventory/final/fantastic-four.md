<!-- INVENTORY STATUS:
  Heroes: ✅ Pass 2 verified
  Villains: ✅ Pass 2 verified
  Masterminds: ✅ Pass 2 verified
  Schemes: ✅ Pass 2 verified
...
**Pass 2 status**: Complete — 10 corrections applied, all ⚠️ flags resolved via physical card spot-check
...
- SPECIAL ABILITY: NA
- SUPERPOWER: NA
- Keywords: Focus 2 — Rescue a Bystander. You may only use this ability up to four times this turn.
...
Setup: 8 Twists. 1 Villain Group, 1 Henchmen Group, 3 Heroes.
Special Rules: Even-numbered Twists swap costs: enemies cost Recruit to fight and Heroes cost Attack to recruit. Odd-numbered Twists (after the first) revert to normal.
