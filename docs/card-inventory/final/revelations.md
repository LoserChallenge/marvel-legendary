# Revelations — Card Inventory

**Primary source**: `expansions/revelations/revelations-inventory.pdf`, `expansions/revelations/revelations-reference.md` (BGG wiki)
**Cross-check**: Card images in `expansions/revelations/`
**Pass 1 date**: 2026-04-02
**Pass 2 date**: 2026-04-04
**Pass 2 status**: ✅ Complete — 0 corrections needed (all entries verified clean)
