...
Last updated: 2026-06-21 (Shadows of Nightmare FINALIZED through Pass 3. Weapon X + Messiah Complex + New Mutants + SHIELD Pass 2 complete (reference-first, all clean; minor Pass-3 items noted per draft). **World War Hulk FINALIZED through Pass 3 (2026-06-22) — reference-first, 0 ❌; 3 physical-card corrections applied. ALL Pass-2 verifications now done.** Inventory protocol changed to reference-first; see card-reading-rules.md.)
